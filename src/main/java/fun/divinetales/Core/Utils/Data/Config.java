...
public class Config {
    ...
    public Config(String filename, Boolean saveDefault) {
    ...
    public Config(String folder, String filename, Boolean saveDefault) {
        if (!filename.endsWith(".yml"))
            filename = filename + ".yml";
        this.FILENAME = filename;
        this.PLUGIN = CoreMain.getInstance();
    ...
    public Config(File folder, String filename, Boolean saveDefault) {
        if (!filename.endsWith(".yml"))
            filename = filename + ".yml";
        this.FILENAME = filename;
        this.PLUGIN = CoreMain.getInstance();
    ...
    public Config(File folder, String filename, Plugin pl, Boolean saveDefault) {
        if (!filename.endsWith(".yml"))
            filename = filename + ".yml";
        this.FILENAME = filename;
        this.PLUGIN = pl;
