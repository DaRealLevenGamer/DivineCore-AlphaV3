...
import fun.divinetales.Core.Coammnds.SubCommands.Profile.ChangeSkinURL;
import fun.divinetales.Core.Coammnds.SubCommands.Profile.SetProfileInfo;
...
public class ProfileCommand implements TabExecutor {
    ...
    public ProfileCommand() {
        subCommands.add(new SetProfileInfo());
        subCommands.add(new ChangeSkinURL());
    }
